export const pieceDefs = {
  levy: {
    pieceType: 'levy',
    imageLocation: "../../resources/levyBlack.svg",
    health: 3,
    attack: 1,
    lore:
  ...
  archer: {
    pieceType: 'archer',
    imageLocation: "../../resources/archerBlack.svg",
    health: 2,
    lore:
  ...
  legion: {
    pieceType: 'legion',
    imageLocation: "../../resources/legionBlack.svg",
    health: 8,
    lore:
  ...
  cataphract: {
    ...
    imageLocation: "../../resources/ctaphractBlack.svg",
    health: 8,
    lore:
  ...
  chariot: {
    pieceType: 'chariot',
    imageLocation: "../../resources/chariotBlack.svg",
    health: 10,
    lore:
  ...
  warElephant: {
    ...
    imageLocation: "../../resources/warElephantBlack.svg",
    health: 20,
    lore:
  ...
  lightCavalry: {
    ...
    imageLocation: "../../resources/lightCavalryBlack.svg",
    health: 4,
    lore:
  ...
  centaur: {
    pieceType: 'centaur',
    imageLocation: "../../resources/centaurBlack.svg",
    health: 4,
    lore:
  ...
  general: {
    pieceType: 'general',
    imageLocation: "../../resources/generalBlack.svg",
    health: 10,
    lore:
